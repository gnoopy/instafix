...
`),r}function Fo(){let n=navigator.userAgentData;return n?n.platform==="macOS":navigator.platform?.includes("Mac")??/Macintosh|Mac OS X/i.test(navigator.userAgent)}var Ct=class{constructor(t,e,o){this.colors=t;this.t=e;this.agentInstructions=o;this.root=chunkKHQKVTLZ_cjs.j("div",{style:`
      ...
      `}),this.root.setAttribute("role","dialog"),this.root.setAttribute("aria-modal","true"),this.root.setAttribute("data-instafix-ignore","true"),this.sourceHintEl=chunkKHQKVTLZ_cjs.j("div",{style:`
      ...
      `}),this.pastedImageRow=chunkKHQKVTLZ_cjs.j("div",{style:"display:none;align-items:center;gap:8px;margin:8px 0 0;"}),this.pastedImageThumb=document.createElement("img"),this.pastedImageThumb.style.cssText=`
      height:40px;max-width:120px;border-radius:7px;object-fit:cover;
      border:1px solid ${this.colors.border};
    `;let i=chunkKHQKVTLZ_cjs.j("span",{style:`font-size:11px;color:${this.colors.textTertiary};font-family:${chunkKHQKVTLZ_cjs.a};`});chunkKHQKVTLZ_cjs.k(i,"\u{1F4CE}");let s=document.createElement("button");s.type="button",s.style.cssText=`
      border:none;background:none;color:${this.colors.textTertiary};
      font-family:${chunkKHQKVTLZ_cjs.a};font-size:11px;font-weight:600;
      text-decoration:underline;cursor:pointer;padding:0;
    `,chunkKHQKVTLZ_cjs.k(s,"\xD7"),s.setAttribute("aria-label","remove pasted image"),s.addEventListener("click",()=>this.setPastedImage(null)),this.pastedImageRow.appendChild(this.pastedImageThumb),this.pastedImageRow.appendChild(i),this.pastedImageRow.appendChild(s),this.targetSizeRow=chunkKHQKVTLZ_cjs.j("div",{style:"display:none;align-items:center;gap:6px;margin-bottom:10px;"}),this.targetLabelEl=chunkKHQKVTLZ_cjs.j("span",{style:`font-size:11px;color:${this.colors.textTertiary};font-family:${chunkKHQKVTLZ_cjs.a};flex-shrink:0;`});let r=chunkKHQKVTLZ_cjs.j("div",{style:`display:flex;border-radius:9999px;border:1px solid ${this.colors.border};padding:2px;gap:2px;`}),a=()=>{let w=document.createElement("button");return w.type="button",w.style.cssText=`
        border:none;border-radius:9999px;padding:3px 10px;cursor:pointer;
        font-family:${chunkKHQKVTLZ_cjs.a};
        font-size:11px;font-weight:600;
        transition:background 0.15s ease,color 0.15s ease;
      `,w};this.targetSmallestBtn=a(),this.targetSmallestBtn.addEventListener("click",()=>this.selectTargetSize("smallest")),this.targetLargestBtn=a(),this.targetLargestBtn.addEventListener("click",()=>this.selectTargetSize("largest")),r.appendChild(this.targetSmallestBtn),r.appendChild(this.targetLargestBtn),this.targetSizeRow.appendChild(this.targetLabelEl),this.targetSizeRow.appendChild(r),this.legendRow=chunkKHQKVTLZ_cjs.j("div",{style:"display:none;flex-direction:column;gap:4px;margin-bottom:10px;"}),this.legendHeadingEl=chunkKHQKVTLZ_cjs.j("span",{style:`font-size:10.5px;font-weight:600;text-transform:uppercase;letter-spacing:0.02em;color:${this.colors.textTertiary};`}),this.legendListEl=chunkKHQKVTLZ_cjs.j("div",{style:"display:flex;flex-wrap:wrap;gap:4px 10px;"}),this.legendRow.appendChild(this.legendHeadingEl),this.legendRow.appendChild(this.legendListEl);let c=[{type:"question",icon:chunkKHQKVTLZ_cjs.J},{type:"change",icon:chunkKHQKVTLZ_cjs.K},{type:"bug",icon:chunkKHQKVTLZ_cjs.L},{type:"other",icon:chunkKHQKVTLZ_cjs.M}];this.typeRow=chunkKHQKVTLZ_cjs.j("div",{style:"display:grid;grid-template-columns:repeat(4, 1fr);gap:5px;margin-bottom:12px;"});for(let w of c){let v=document.createElement("button");v.style.cssText=`
        height:36px;
        ...
        padding:0 4px;
        min-width:0;
      `;let C=chunkKHQKVTLZ_cjs.i(w.icon);C.setAttribute("style","width:12px;height:12px;flex-shrink:0;"),v.appendChild(C);let H=document.createElement("span");H.style.cssText="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0;",v.appendChild(H),v.dataset.type=w.type,v.setAttribute("aria-pressed","false"),v.addEventListener("click",()=>{this.submittingState||this.selectType(w.type,this.typeRow);}),v.addEventListener("mouseenter",()=>{if(!this.submittingState&&v.dataset.type!==this.selectedType){let R=chunkKHQKVTLZ_cjs.la(v.dataset.type??"",this.colors);v.style.background=R,v.style.borderColor=chunkKHQKVTLZ_cjs.ia(v.dataset.type??"",this.colors)+"40";}}),v.addEventListener("mouseleave",()=>{this.submittingState||v.dataset.type!==this.selectedType&&(v.style.background=this.colors.glassBg,v.style.borderColor=this.colors.border);}),this.typeRow.appendChild(v);}this.draftBanner=chunkKHQKVTLZ_cjs.j("div",{style:`
        display:none;
    ...
    `,d.addEventListener("click",()=>{this.textarea.value="",this.clearedMessage=null,this.setComposerActionEnabled(this.undoClearBtn,false),this.setComposerActionEnabled(this.redoClearBtn,false),tt(),this.hideDraftBanner(),this.updateSubmitState(),this.textarea.focus();}),this.draftBanner.appendChild(l),this.draftBanner.appendChild(d),this.draftLabelEl=l,this.draftDiscardBtn=d,this.textareaWrap=chunkKHQKVTLZ_cjs.j("div",{style:"position:relative;"}),this.textarea=document.createElement("textarea"),this.textarea.style.cssText=`
      ...
      box-sizing:border-box;
    `,this.textarea.maxLength=5e3;let h=chunkKHQKVTLZ_cjs.j("div",{style:`
    ...
    `,this.cancelBtn.addEventListener("click",()=>this.cancel()),this.cancelBtn.addEventListener("mouseenter",()=>{this.submittingState||(this.cancelBtn.style.borderColor=this.colors.accent,this.cancelBtn.style.color=this.colors.accent);}),this.cancelBtn.addEventListener("mouseleave",()=>{this.submittingState||(this.cancelBtn.style.borderColor=this.colors.border,this.cancelBtn.style.color=this.colors.textTertiary);}),this.submitBtn=document.createElement("button"),this.submitBtn.style.cssText=`
      ...
      color:#fff;font-family:${chunkKHQKVTLZ_cjs.a};
    ...
    `,!(typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)&&typeof t.animate=="function"&&(this.spinnerAnimation=t.animate([{transform:"rotate(0deg)"},{transform:"rotate(360deg)"}],{duration:600,iterations:1/0,easing:"linear"})),t}hideElement(){this.draftSaveTimer&&(clearTimeout(this.draftSaveTimer),this.draftSaveTimer=null),this.onKeydownTrap&&(this.root.removeEventListener("keydown",this.onKeydownTrap),this.onKeydownTrap=null),this.onWindowChange&&(window.removeEventListener("scroll",this.onWindowChange,true),window.removeEventListener("resize",this.onWindowChange),this.onWindowChange=null),this.voiceController?.currentState==="listening"&&this.voiceController.stop(),this.submittingState&&this.exitSubmittingState(),this.onSubmit=null,this.root.style.opacity="0",this.root.style.transform="translateY(8px) scale(0.98)",this.previouslyFocused?.focus(),this.previouslyFocused=null,setTimeout(()=>{this.root.style.display="none";},250);}destroy(){this.draftSaveTimer&&(clearTimeout(this.draftSaveTimer),this.draftSaveTimer=null),this.copyResetTimer&&(clearTimeout(this.copyResetTimer),this.copyResetTimer=null),this.submittingState&&this.exitSubmittingState(),this.resolve?.(null),this.resolve=null,this.onSubmit=null,this.onKeydownTrap&&(this.root.removeEventListener("keydown",this.onKeydownTrap),this.onKeydownTrap=null);for(let t of this.voiceUnsubs)t();this.voiceUnsubs=[],this.voiceController?.destroy(),this.voiceController=null,this.root.remove();}};var rt,gn=false;async function Bo(){if(rt!==void 0)return rt;try{let n=await import('./html2canvas-pro.esm-A4KD7LND.cjs');return rt=n.default??n,rt}catch(n){return rt=null,gn||(gn=true,console.warn("[instafix] html2canvas import failed unexpectedly. Capture is disabled for this session \u2014 feedbacks are still submitted, just without screenshots. Underlying error:",n)),null}}function re(n,t,e){return Math.min(e,Math.max(n,t))}function At(n){return re(0,Math.round(n*1e4)/1e4,1)}async function bn(n,t){let e=await Bo();if(!e)return null;let o=.85,i=1200,s=re(48,n.width*.6,280),r=re(48,n.height*.6,220),a=window.scrollX+n.x,c=window.scrollY+n.y,l=Math.max(document.documentElement.scrollWidth,document.body.scrollWidth),d=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight),h=Math.max(0,a-s),p=Math.max(0,c-r),m=Math.min(l,a+n.width+s)-h,f=Math.min(d,c+n.height+r)-p;if(m<=0||f<=0)return null;let y={xPct:At((a-h)/m),yPct:At((c-p)/f),wPct:At(n.width/m),hPct:At(n.height/f)};try{let E=await e(document.body,{x:h,y:p,width:m,height:f,scale:window.devicePixelRatio,useCORS:!0,allowTaint:!0,logging:!1,ignoreElements:w=>w.tagName==="INSTAFIX-WIDGET"||w.closest?.("instafix-widget")!==null||w.getAttribute?.("data-instafix-ignore")==="true"});if(E.width<=i)return {dataUrl:E.toDataURL("image/jpeg",o),region:y};let k=i/E.width,b=i,B=Math.round(E.height*k),A=document.createElement("canvas");A.width=b,A.height=B;let L=A.getContext("2d");return L?(L.drawImage(E,0,0,b,B),{dataUrl:A.toDataURL("image/jpeg",o),region:y}):null}catch(E){return console.warn("[instafix] Screenshot capture failed:",E),null}}var Rt=class{constructor(t,e,o,i=false,s,r){this.colors=t;this.bus=e;this.t=o;this.enableScreenshot=i;this.getFallbackTarget=s;this.popup=new Ct(t,o,r),this.bus.on("annotation:start",()=>this.activate()),this.bus.on("targeting:start",()=>this.activateTargeting()),this.bus.on("targeting:end",()=>this.deactivateTargeting());}colors;bus;t;enableScreenshot;getFallbackTarget;overlay=null;toolbar=null;drawingRect=null;startX=0;startY=0;startScrollX=0;startScrollY=0;isDrawing=false;isActive=false;instantMode=false;popup;savedOverflow="";preActiveFocusElement=null;keyboardTarget=null;rafId=null;pendingMoveEvent=null;rejectPendingSubmission=null;accumulated=[];motionPauseHandle=null;autoScrollTimer=null;lastPointerClient=null;instructionEl=null;targetingModeActive=false;targetingHighlight=null;targetingHoveredElement=null;targetingRafId=null;pendingTargetingMoveEvent=null;get isBusy(){return this.isActive}refreshLabels(){this.popup.refreshLabels();}async maybeCapture(t){return this.enableScreenshot?bn(t):null}activate(){if(this.isActive)return;this.targetingModeActive&&this.bus.emit("targeting:end"),this.isActive=true;let t=!this.instantMode;this.motionPauseHandle=an(),this.preActiveFocusElement=document.activeElement;let e=document.activeElement;if(this.keyboardTarget=e instanceof HTMLElement&&e!==document.body&&e!==document.documentElement&&!chunkKHQKVTLZ_cjs.b(e)?e:this.getFallbackTarget?.()??null,this.savedOverflow=document.body.style.overflow,document.body.style.overflow="hidden",this.overlay=chunkKHQKVTLZ_cjs.j("div",{style:`
      ...
      `}),this.overlay.setAttribute("role","application"),this.overlay.setAttribute("aria-label",t?this.t("annotator.instruction"):this.t("annotator.instantInstruction")),this.overlay.setAttribute("data-instafix-ignore","true"),t){this.toolbar=chunkKHQKVTLZ_cjs.j("div",{style:`
          ...
          -webkit-font-smoothing:antialiased;
        `}),this.toolbar.setAttribute("data-instafix-ignore","true");let o=chunkKHQKVTLZ_cjs.j("span",{style:`
          width:8px;height:8px;border-radius:50%;
          background:${this.colors.accent};
          box-shadow:0 0 8px ${this.colors.accentGlow};
          animation:pulse 1.5s ease-in-out infinite;
        `}),i=document.createElement("style");i.textContent=["@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.4}}","@media(prefers-reduced-motion:reduce){@keyframes pulse{from,to{opacity:1}}}"].join(""),this.toolbar.appendChild(i);let s=chunkKHQKVTLZ_cjs.j("span",{style:"font-weight:500;letter-spacing:-0.01em;"});chunkKHQKVTLZ_cjs.k(s,this.t("annotator.instruction")),this.instructionEl=s;let r=document.createElement("button");r.style.cssText=`
        height:34px;padding:0 18px;border-radius:9999px;
        border:1px solid ${this.colors.border};
        background:${this.colors.glassBg};
        color:${this.colors.textTertiary};font-family:${chunkKHQKVTLZ_cjs.a};
...
`,_t=class{constructor(t,e,o,i){this.t=e;this.anchor=o;this.alignRight=i;this.element=chunkKHQKVTLZ_cjs.j("div",{class:"sp-onboarding"}),this.element.setAttribute("role","dialog"),this.element.setAttribute("aria-label",this.t("onboarding.step1Title")),this.closeBtn=document.createElement("button"),this.closeBtn.type="button",this.closeBtn.className="sp-onboarding-close",this.closeBtn.setAttribute("aria-label",this.t("onboarding.skip")),this.closeBtn.appendChild(chunkKHQKVTLZ_cjs.i(chunkKHQKVTLZ_cjs.G)),this.closeBtn.addEventListener("click",()=>this.finish()),this.element.appendChild(this.closeBtn),this.titleEl=chunkKHQKVTLZ_cjs.j("div",{class:"sp-onboarding-title"}),this.bodyEl=chunkKHQKVTLZ_cjs.j("div",{class:"sp-onboarding-body"}),this.element.appendChild(this.titleEl),this.element.appendChild(this.bodyEl);let s=chunkKHQKVTLZ_cjs.j("div",{class:"sp-onboarding-footer"});this.progressEl=chunkKHQKVTLZ_cjs.j("span",{class:"sp-onboarding-progress"}),s.appendChild(this.progressEl);let r=chunkKHQKVTLZ_cjs.j("div",{class:"sp-onboarding-actions"});this.skipBtn=document.createElement("button"),this.skipBtn.type="button",this.skipBtn.className="sp-onboarding-skip",chunkKHQKVTLZ_cjs.k(this.skipBtn,this.t("onboarding.skip")),this.skipBtn.addEventListener("click",()=>this.finish()),this.nextBtn=document.createElement("button"),this.nextBtn.type="button",this.nextBtn.className="sp-onboarding-next",this.nextBtn.addEventListener("click",()=>this.advance()),r.appendChild(this.skipBtn),r.appendChild(this.nextBtn),s.appendChild(r),this.element.appendChild(s),t.appendChild(this.element),this.onKeydown=a=>this.handleKeydown(a),document.addEventListener("keydown",this.onKeydown,true),this.renderStep(),this.position(),requestAnimationFrame(()=>{this.element.classList.add("sp-onboarding--visible"),this.nextBtn.focus();});}t;anchor;alignRight;element;titleEl;bodyEl;progressEl;nextBtn;skipBtn;closeBtn;onKeydown;stepIndex=0;finished=false;renderStep(){let t=Ot[this.stepIndex];if(!t)return;chunkKHQKVTLZ_cjs.k(this.titleEl,this.t(t.titleKey)),chunkKHQKVTLZ_cjs.k(this.bodyEl,this.t(t.bodyKey)),chunkKHQKVTLZ_cjs.k(this.progressEl,chunkKHQKVTLZ_cjs.A(this.t,"onboarding.progress",{current:this.stepIndex+1,total:Ot.length}));let e=this.stepIndex===Ot.length-1;chunkKHQKVTLZ_cjs.k(this.nextBtn,this.t(e?"onboarding.done":"onboarding.next"));}advance(){if(this.stepIndex>=Ot.length-1){this.finish();return}this.stepIndex+=1,this.renderStep(),this.position();}handleKeydown(t){if(this.finished)return;if(t.key==="Escape"){t.stopPropagation(),this.finish();return}if(t.key!=="Tab")return;let o=this.element.getRootNode().activeElement;if(!o||!this.element.contains(o))return;let i=[this.closeBtn,this.skipBtn,this.nextBtn],s=i[0],r=i[i.length-1];!s||!r||(t.shiftKey&&o===s?(t.preventDefault(),r.focus()):!t.shiftKey&&o===r&&(t.preventDefault(),s.focus()));}position(){let t=this.anchor.getBoundingClientRect(),e=this.element.getBoundingClientRect(),o=14,i=t.top-e.height-o;i<8&&(i=t.bottom+o);let s;this.alignRight?s=t.right-e.width:s=t.left,s=Math.max(8,Math.min(s,window.innerWidth-e.width-8)),this.element.style.top=`${i}px`,this.element.style.left=`${s}px`;}finish(){this.finished||(this.finished=true,fi(),document.removeEventListener("keydown",this.onKeydown,true),this.element.remove(),this.anchor.focus());}destroy(){this.finished||(this.finished=true,document.removeEventListener("keydown",this.onKeydown,true),this.element.remove());}};var Dt=class{constructor(t,e){this.store=t;this.projectName=e;}store;projectName;async sendFeedback(t){let e=await this.store.createFeedback({projectName:t.projectName,type:t.type,message:t.message,status:"open",url:t.url,urlPattern:t.urlPattern??null,viewport:t.viewport,userAgent:t.userAgent,authorName:t.authorName,authorEmail:t.authorEmail,clientId:t.clientId,annotations:t.annotations.map(chunkKHQKVTLZ_cjs.s),screenshotDataUrl:t.screenshotDataUrl??null,screenshotRegion:t.screenshotRegion??null,diagnostics:t.diagnostics??null});return dt(e)}async getFeedbacks(t,e){let{feedbacks:o,total:i}=await this.store.getFeedbacks({projectName:t,page:e?.page,limit:e?.limit,type:e?.type,status:e?.status,statuses:e?.statuses,search:e?.search,url:e?.url,urlPattern:e?.urlPattern});return {feedbacks:o.map(dt),total:i}}async resolveFeedback(t,e){let o=await this.store.updateFeedback(t,chunkKHQKVTLZ_cjs.r(e?"resolved":"open"));return dt(o)}async updateFeedbackMessage(t,e,o){let i=await this.store.updateFeedback(t,chunkKHQKVTLZ_cjs.r(e,new Date,o));return dt(i)}async updateFeedbackAnnotations(t,e,o){let i=await this.store.updateFeedback(t,chunkKHQKVTLZ_cjs.r(e,new Date,void 0,o.map(chunkKHQKVTLZ_cjs.s)));return dt(i)}async deleteFeedback(t){await this.store.deleteFeedback(t);}async deleteAllFeedbacks(t){await this.store.deleteAllFeedbacks(t);}};function dt(n){return {id:n.id,projectName:n.projectName,type:n.type,message:n.message,status:n.status,url:n.url,urlPattern:n.urlPattern??null,viewport:n.viewport,userAgent:n.userAgent,authorName:n.authorName,authorEmail:n.authorEmail,resolvedAt:n.resolvedAt?.toISOString()??null,createdAt:n.createdAt.toISOString(),updatedAt:n.updatedAt.toISOString(),annotations:n.annotations.map(mi),screenshotUrl:n.screenshotUrl??null,screenshotRegion:n.screenshotRegion??null,diagnostics:n.diagnostics??null}}function mi(n){return {id:n.id,feedbackId:n.feedbackId,cssSelector:n.cssSelector,xpath:n.xpath,textSnippet:n.textSnippet,elementTag:n.elementTag,elementId:n.elementId,textPrefix:n.textPrefix,textSuffix:n.textSuffix,fingerprint:n.fingerprint,neighborText:n.neighborText,anchorKey:n.anchorKey??null,xPct:n.xPct,yPct:n.yPct,wPct:n.wPct,hPct:n.hPct,scrollX:n.scrollX,scrollY:n.scrollY,viewportW:n.viewportW,viewportH:n.viewportH,devicePixelRatio:n.devicePixelRatio,createdAt:n.createdAt.toISOString(),target:n.target??null,inspect:n.inspect??null}}var gi="linear(0, 0.006, 0.025, 0.06, 0.11, 0.17, 0.25, 0.34, 0.45, 0.56, 0.67, 0.78, 0.88, 0.95, 1.01, 1.04, 1.05, 1.04, 1.02, 1, 0.99, 1)",me="cubic-bezier(0.16, 1, 0.3, 1)",qn="cubic-bezier(0.34, 1.56, 0.64, 1)",bi="cubic-bezier(0.25, 1, 0.5, 1)",Un=`
  /* ---- Keyframes ---- */
...
`;function ge(n){return `
    ...
    *, *::before, *::after {
    ...
    ${Un}
    ${chunkKHQKVTLZ_cjs.Ca}
    ${chunkKHQKVTLZ_cjs.Ba}
    ${chunkKHQKVTLZ_cjs.ta}
    ${chunkKHQKVTLZ_cjs.ra}
    ${chunkKHQKVTLZ_cjs.Ja}
    ${chunkKHQKVTLZ_cjs.va}
    ${chunkKHQKVTLZ_cjs.Fa}
    ${chunkKHQKVTLZ_cjs.aa}
    ${Wn}
  `}var yi=120,vi=80,$t=class{constructor(t,e="en"){this.colors=t;this.locale=e;this.root=chunkKHQKVTLZ_cjs.j("div",{style:`
        position: fixed;
        z-index: ${2147483647};
        max-width: 280px;
        padding: 12px 14px;
        ...
        visibility: hidden;
        -webkit-font-smoothing: antialiased;
      `}),this.root.setAttribute("role","tooltip"),this.root.id=this.tooltipId,this.arrow=chunkKHQKVTLZ_cjs.j("div",{style:`
        position: absolute;
        width: 12px;
        height: 12px;
        background: ${this.colors.layerBgHeavy};
        ...
        pointer-events: none;
      `}),this.root.appendChild(this.arrow),this.root.addEventListener("mouseenter",()=>this.cancelHide()),this.root.addEventListener("mouseleave",()=>this.scheduleHide()),document.body.appendChild(this.root);}colors;locale;root;arrow;showTimer=null;hideTimer=null;currentFeedbackId=null;tooltipId="sp-tooltip";show(t,e){this.currentFeedbackId!==t.id&&(this.cancelHide(),this.cancelShow(),this.showTimer=setTimeout(()=>{this.currentFeedbackId=t.id,this.render(t),this.position(e);let o=typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;this.root.style.transition=o?"none":"",this.root.style.visibility="visible",this.root.style.opacity="1",this.root.style.transform="translateY(0) scale(1)";},yi));}scheduleHide(){this.cancelHide(),this.hideTimer=setTimeout(()=>this.hide(),vi);}hide(){this.cancelShow(),this.currentFeedbackId=null,this.root.style.opacity="0",this.root.style.transform="translateY(6px) scale(0.97)",setTimeout(()=>{this.currentFeedbackId||(this.root.style.visibility="hidden");},200);}cancelShow(){this.showTimer&&(clearTimeout(this.showTimer),this.showTimer=null);}cancelHide(){this.hideTimer&&(clearTimeout(this.hideTimer),this.hideTimer=null);}render(t){let e=Array.from(this.root.children);for(let h of e)h!==this.arrow&&h.remove();let o=chunkKHQKVTLZ_cjs.ia(t.type,this.colors),i=chunkKHQKVTLZ_cjs.la(t.type,this.colors),s=chunkKHQKVTLZ_cjs.z(this.locale),r=chunkKHQKVTLZ_cjs.B(t.type,s),a=chunkKHQKVTLZ_cjs.j("div",{style:"display:flex;align-items:center;gap:8px;margin-bottom:8px;"}),c=chunkKHQKVTLZ_cjs.j("span",{style:`
        padding:3px 10px;border-radius:9999px;
        font-size:11px;font-weight:600;
        color:${o};background:${i};
        letter-spacing:0.02em;
      `});chunkKHQKVTLZ_cjs.k(c,r);let l=chunkKHQKVTLZ_cjs.j("span",{style:`font-size:11px;color:${this.colors.textSecondary};margin-left:auto;`});chunkKHQKVTLZ_cjs.k(l,chunkKHQKVTLZ_cjs.m(t.createdAt,this.locale)),a.appendChild(c),a.appendChild(l);let d=chunkKHQKVTLZ_cjs.j("div",{style:`font-size:13px;line-height:1.55;color:${this.colors.text};display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;`});chunkKHQKVTLZ_cjs.k(d,t.message),this.root.insertBefore(a,this.arrow),this.root.insertBefore(d,this.arrow);}position(t){let e=this.root.getBoundingClientRect(),o=10,i=t.top-e.height-o,s=t.left+t.width/2-e.width/2,r=true;i<8&&(i=t.bottom+o,r=false),s=Math.max(8,Math.min(s,window.innerWidth-e.width-8)),this.root.style.top=`${i}px`,this.root.style.left=`${s}px`;let a=Math.max(16,Math.min(t.left+t.width/2-s-6,e.width-22));r?this.arrow.style.cssText=`
        position:absolute;
