import { InstaFixIdentity, InstaFixConfig, InstaFixInstance } from './instafix-core.js';
export { AnchorData, AnnotationPayload, AnnotationResponse, FeedbackPayload, FeedbackResponse, FeedbackStatus, FeedbackType, InstaFixConfig, InstaFixHeadersOption, InstaFixHttpConfig, InstaFixInstance, InstaFixLocale, InstaFixPublicEvents, InstaFixStore, InstaFixStoreConfig, RectData } from './instafix-core.js';
