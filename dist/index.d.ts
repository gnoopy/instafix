import { FeedbackRecord, FeedbackStatus, FeedbackPayload, FeedbackType, InstaFixStore, ScreenshotStorage, FeedbackCreateInput, FeedbackQuery, FeedbackPage, FeedbackUpdateInput } from './instafix-core.js';
export { InstaFixStore, ScreenshotStorage, StoreDuplicateError, StoreNotFoundError, StorePersistenceError, flattenAnnotation, isStorePersistence } from './instafix-core.js';
