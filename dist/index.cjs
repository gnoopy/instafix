...
`),r}function Fo(){let n=navigator.userAgentData;return n?n.platform==="macOS":navigator.platform?.includes("Mac")??/Macintosh|Mac OS X/i.test(navigator.userAgent)}var Ct=class{constructor(t,e,o){this.colors=t;this.t=e;this.agentInstructions=o;this.root=chunkBFI4TNSD_cjs.j("div",{style:`
      ...
      `}),this.root.setAttribute("role","dialog"),this.root.setAttribute("aria-modal","true"),this.root.setAttribute("data-instafix-ignore","true"),this.sourceHintEl=chunkBFI4TNSD_cjs.j("div",{style:`
      ...
      `}),this.pastedImageRow=chunkBFI4TNSD_cjs.j("div",{style:"display:none;align-items:center;gap:8px;margin:8px 0 0;"}),this.pastedImageThumb=document.createElement("img"),this.pastedImageThumb.style.cssText=`
      height:40px;max-width:120px;border-radius:7px;object-fit:cover;
      border:1px solid ${this.colors.border};
    `;let i=chunkBFI4TNSD_cjs.j("span",{style:`font-size:11px;color:${this.colors.textTertiary};font-family:${chunkBFI4TNSD_cjs.a};`});chunkBFI4TNSD_cjs.k(i,"\u{1F4CE}");let s=document.createElement("button");s.type="button",s.style.cssText=`
      border:none;background:none;color:${this.colors.textTertiary};
      font-family:${chunkBFI4TNSD_cjs.a};font-size:11px;font-weight:600;
      text-decoration:underline;cursor:pointer;padding:0;
    `,chunkBFI4TNSD_cjs.k(s,"\xD7"),s.setAttribute("aria-label","remove pasted image"),s.addEventListener("click",()=>this.setPastedImage(null)),this.pastedImageRow.appendChild(this.pastedImageThumb),this.pastedImageRow.appendChild(i),this.pastedImageRow.appendChild(s),this.targetSizeRow=chunkBFI4TNSD_cjs.j("div",{style:"display:none;align-items:center;gap:6px;margin-bottom:10px;"}),this.targetLabelEl=chunkBFI4TNSD_cjs.j("span",{style:`font-size:11px;color:${this.colors.textTertiary};font-family:${chunkBFI4TNSD_cjs.a};flex-shrink:0;`});let r=chunkBFI4TNSD_cjs.j("div",{style:`display:flex;border-radius:9999px;border:1px solid ${this.colors.border};padding:2px;gap:2px;`}),a=()=>{let w=document.createElement("button");return w.type="button",w.style.cssText=`
        border:none;border-radius:9999px;padding:3px 10px;cursor:pointer;
        font-family:${chunkBFI4TNSD_cjs.a};
        font-size:11px;font-weight:600;
        transition:background 0.15s ease,color 0.15s ease;
      `,w};this.targetSmallestBtn=a(),this.targetSmallestBtn.addEventListener("click",()=>this.selectTargetSize("smallest")),this.targetLargestBtn=a(),this.targetLargestBtn.addEventListener("click",()=>this.selectTargetSize("largest")),r.appendChild(this.targetSmallestBtn),r.appendChild(this.targetLargestBtn),this.targetSizeRow.appendChild(this.targetLabelEl),this.targetSizeRow.appendChild(r),this.legendRow=chunkBFI4TNSD_cjs.j("div",{style:"display:none;flex-direction:column;gap:4px;margin-bottom:10px;"}),this.legendHeadingEl=chunkBFI4TNSD_cjs.j("span",{style:`font-size:10.5px;font-weight:600;text-transform:uppercase;letter-spacing:0.02em;color:${this.colors.textTertiary};`}),this.legendListEl=chunkBFI4TNSD_cjs.j("div",{style:"display:flex;flex-wrap:wrap;gap:4px 10px;"}),this.legendRow.appendChild(this.legendHeadingEl),this.legendRow.appendChild(this.legendListEl);let c=[{type:"question",icon:chunkBFI4TNSD_cjs.K},{type:"change",icon:chunkBFI4TNSD_cjs.L},{type:"bug",icon:chunkBFI4TNSD_cjs.M},{type:"other",icon:chunkBFI4TNSD_cjs.N}];this.typeRow=chunkBFI4TNSD_cjs.j("div",{style:"display:grid;grid-template-columns:repeat(4, 1fr);gap:5px;margin-bottom:12px;"});for(let w of c){let v=document.createElement("button");v.style.cssText=`
        height:36px;
        ...
        padding:0 4px;
        min-width:0;
      `;let C=chunkBFI4TNSD_cjs.i(w.icon);C.setAttribute("style","width:12px;height:12px;flex-shrink:0;"),v.appendChild(C);let H=document.createElement("span");H.style.cssText="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0;",v.appendChild(H),v.dataset.type=w.type,v.setAttribute("aria-pressed","false"),v.addEventListener("click",()=>{this.submittingState||this.selectType(w.type,this.typeRow);}),v.addEventListener("mouseenter",()=>{if(!this.submittingState&&v.dataset.type!==this.selectedType){let R=chunkBFI4TNSD_cjs.ma(v.dataset.type??"",this.colors);v.style.background=R,v.style.borderColor=chunkBFI4TNSD_cjs.ja(v.dataset.type??"",this.colors)+"40";}}),v.addEventListener("mouseleave",()=>{this.submittingState||v.dataset.type!==this.selectedType&&(v.style.background=this.colors.glassBg,v.style.borderColor=this.colors.border);}),this.typeRow.appendChild(v);}this.draftBanner=chunkBFI4TNSD_cjs.j("div",{style:`
        display:none;
    ...
    `,this.cancelBtn.addEventListener("click",()=>this.cancel()),this.cancelBtn.addEventListener("mouseenter",()=>{this.submittingState||(this.cancelBtn.style.borderColor=this.colors.accent,this.cancelBtn.style.color=this.colors.accent);}),this.cancelBtn.addEventListener("mouseleave",()=>{this.submittingState||(this.cancelBtn.style.borderColor=this.colors.border,this.cancelBtn.style.color=this.colors.textTertiary);}),this.submitBtn=document.createElement("button"),this.submitBtn.style.cssText=`
      ...
      color:#fff;font-family:${chunkBFI4TNSD_cjs.a};
    ...
    `,!(typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches)&&typeof t.animate=="function"&&(this.spinnerAnimation=t.animate([{transform:"rotate(0deg)"},{transform:"rotate(360deg)"}],{duration:600,iterations:1/0,easing:"linear"})),t}hideElement(){this.draftSaveTimer&&(clearTimeout(this.draftSaveTimer),this.draftSaveTimer=null),this.onKeydownTrap&&(this.root.removeEventListener("keydown",this.onKeydownTrap),this.onKeydownTrap=null),this.onWindowChange&&(window.removeEventListener("scroll",this.onWindowChange,true),window.removeEventListener("resize",this.onWindowChange),this.onWindowChange=null),this.voiceController?.currentState==="listening"&&this.voiceController.stop(),this.submittingState&&this.exitSubmittingState(),this.onSubmit=null,this.root.style.opacity="0",this.root.style.transform="translateY(8px) scale(0.98)",this.previouslyFocused?.focus(),this.previouslyFocused=null,setTimeout(()=>{this.root.style.display="none";},250);}destroy(){this.draftSaveTimer&&(clearTimeout(this.draftSaveTimer),this.draftSaveTimer=null),this.copyResetTimer&&(clearTimeout(this.copyResetTimer),this.copyResetTimer=null),this.submittingState&&this.exitSubmittingState(),this.resolve?.(null),this.resolve=null,this.onSubmit=null,this.onKeydownTrap&&(this.root.removeEventListener("keydown",this.onKeydownTrap),this.onKeydownTrap=null);for(let t of this.voiceUnsubs)t();this.voiceUnsubs=[],this.voiceController?.destroy(),this.voiceController=null,this.root.remove();}};var rt,gn=false;async function Bo(){if(rt!==void 0)return rt;try{let n=await import('./html2canvas-pro.esm-A4KD7LND.cjs');return rt=n.default??n,rt}catch(n){return rt=null,gn||(gn=true,console.warn("[instafix] html2canvas import failed unexpectedly. Capture is disabled for this session \u2014 feedbacks are still submitted, just without screenshots. Underlying error:",n)),null}}function ae(n,t,e){return Math.min(e,Math.max(n,t))}function At(n){return ae(0,Math.round(n*1e4)/1e4,1)}async function bn(n,t){let e=await Bo();if(!e)return null;let o=.85,i=1200,s=ae(48,n.width*.6,280),r=ae(48,n.height*.6,220),a=window.scrollX+n.x,c=window.scrollY+n.y,l=Math.max(document.documentElement.scrollWidth,document.body.scrollWidth),d=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight),h=Math.max(0,a-s),p=Math.max(0,c-r),m=Math.min(l,a+n.width+s)-h,f=Math.min(d,c+n.height+r)-p;if(m<=0||f<=0)return null;let y={xPct:At((a-h)/m),yPct:At((c-p)/f),wPct:At(n.width/m),hPct:At(n.height/f)};try{let E=await e(document.body,{x:h,y:p,width:m,height:f,scale:window.devicePixelRatio,useCORS:!0,allowTaint:!0,logging:!1,ignoreElements:w=>w.tagName==="INSTAFIX-WIDGET"||w.closest?.("instafix-widget")!==null||w.getAttribute?.("data-instafix-ignore")==="true"});if(E.width<=i)return {dataUrl:E.toDataURL("image/jpeg",o),region:y};let k=i/E.width,b=i,B=Math.round(E.height*k),A=document.createElement("canvas");A.width=b,A.height=B;let L=A.getContext("2d");return L?(L.drawImage(E,0,0,b,B),{dataUrl:A.toDataURL("image/jpeg",o),region:y}):null}catch(E){return console.warn("[instafix] Screenshot capture failed:",E),null}}var Rt=class{constructor(t,e,o,i=false,s,r){this.colors=t;this.bus=e;this.t=o;this.enableScreenshot=i;this.getFallbackTarget=s;this.popup=new Ct(t,o,r),this.bus.on("annotation:start",()=>this.activate()),this.bus.on("targeting:start",()=>this.activateTargeting()),this.bus.on("targeting:end",()=>this.deactivateTargeting());}colors;bus;t;enableScreenshot;getFallbackTarget;overlay=null;toolbar=null;drawingRect=null;startX=0;startY=0;startScrollX=0;startScrollY=0;isDrawing=false;isActive=false;instantMode=false;popup;savedOverflow="";preActiveFocusElement=null;keyboardTarget=null;rafId=null;pendingMoveEvent=null;rejectPendingSubmission=null;accumulated=[];motionPauseHandle=null;autoScrollTimer=null;lastPointerClient=null;instructionEl=null;targetingModeActive=false;targetingHighlight=null;targetingHoveredElement=null;targetingRafId=null;pendingTargetingMoveEvent=null;get isBusy(){return this.isActive}refreshLabels(){this.popup.refreshLabels();}async maybeCapture(t){return this.enableScreenshot?bn(t):null}activate(){if(this.isActive)return;this.targetingModeActive&&this.bus.emit("targeting:end"),this.isActive=true;let t=!this.instantMode;this.motionPauseHandle=an(),this.preActiveFocusElement=document.activeElement;let e=document.activeElement;if(this.keyboardTarget=e instanceof HTMLElement&&e!==document.body&&e!==document.documentElement&&!chunkBFI4TNSD_cjs.b(e)?e:this.getFallbackTarget?.()??null,this.savedOverflow=document.body.style.overflow,document.body.style.overflow="hidden",this.overlay=chunkBFI4TNSD_cjs.j("div",{style:`
      ...
      `}),this.overlay.setAttribute("role","application"),this.overlay.setAttribute("aria-label",t?this.t("annotator.instruction"):this.t("annotator.instantInstruction")),this.overlay.setAttribute("data-instafix-ignore","true"),t){this.toolbar=chunkBFI4TNSD_cjs.j("div",{style:`
          ...
          -webkit-font-smoothing:antialiased;
        `}),this.toolbar.setAttribute("data-instafix-ignore","true");let o=chunkBFI4TNSD_cjs.j("span",{style:`
          width:8px;height:8px;border-radius:50%;
          background:${this.colors.accent};
          box-shadow:0 0 8px ${this.colors.accentGlow};
          animation:pulse 1.5s ease-in-out infinite;
        `}),i=document.createElement("style");i.textContent=["@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.4}}","@media(prefers-reduced-motion:reduce){@keyframes pulse{from,to{opacity:1}}}"].join(""),this.toolbar.appendChild(i);let s=chunkBFI4TNSD_cjs.j("span",{style:"font-weight:500;letter-spacing:-0.01em;"});chunkBFI4TNSD_cjs.k(s,this.t("annotator.instruction")),this.instructionEl=s;let r=document.createElement("button");r.style.cssText=`
        height:34px;padding:0 18px;border-radius:9999px;
        border:1px solid ${this.colors.border};
        background:${this.colors.glassBg};
        color:${this.colors.textTertiary};font-family:${chunkBFI4TNSD_cjs.a};
...
`,_t=class{constructor(t,e,o,i){this.t=e;this.anchor=o;this.alignRight=i;this.element=chunkBFI4TNSD_cjs.j("div",{class:"sp-onboarding"}),this.element.setAttribute("role","dialog"),this.element.setAttribute("aria-label",this.t("onboarding.step1Title")),this.closeBtn=document.createElement("button"),this.closeBtn.type="button",this.closeBtn.className="sp-onboarding-close",this.closeBtn.setAttribute("aria-label",this.t("onboarding.skip")),this.closeBtn.appendChild(chunkBFI4TNSD_cjs.i(chunkBFI4TNSD_cjs.H)),this.closeBtn.addEventListener("click",()=>this.finish()),this.element.appendChild(this.closeBtn),this.titleEl=chunkBFI4TNSD_cjs.j("div",{class:"sp-onboarding-title"}),this.bodyEl=chunkBFI4TNSD_cjs.j("div",{class:"sp-onboarding-body"}),this.element.appendChild(this.titleEl),this.element.appendChild(this.bodyEl);let s=chunkBFI4TNSD_cjs.j("div",{class:"sp-onboarding-footer"});this.progressEl=chunkBFI4TNSD_cjs.j("span",{class:"sp-onboarding-progress"}),s.appendChild(this.progressEl);let r=chunkBFI4TNSD_cjs.j("div",{class:"sp-onboarding-actions"});this.skipBtn=document.createElement("button"),this.skipBtn.type="button",this.skipBtn.className="sp-onboarding-skip",chunkBFI4TNSD_cjs.k(this.skipBtn,this.t("onboarding.skip")),this.skipBtn.addEventListener("click",()=>this.finish()),this.nextBtn=document.createElement("button"),this.nextBtn.type="button",this.nextBtn.className="sp-onboarding-next",this.nextBtn.addEventListener("click",()=>this.advance()),r.appendChild(this.skipBtn),r.appendChild(this.nextBtn),s.appendChild(r),this.element.appendChild(s),t.appendChild(this.element),this.onKeydown=a=>this.handleKeydown(a),document.addEventListener("keydown",this.onKeydown,true),this.renderStep(),this.position(),requestAnimationFrame(()=>{this.element.classList.add("sp-onboarding--visible"),this.nextBtn.focus();});}t;anchor;alignRight;element;titleEl;bodyEl;progressEl;nextBtn;skipBtn;closeBtn;onKeydown;stepIndex=0;finished=false;renderStep(){let t=Ot[this.stepIndex];if(!t)return;chunkBFI4TNSD_cjs.k(this.titleEl,this.t(t.titleKey)),chunkBFI4TNSD_cjs.k(this.bodyEl,this.t(t.bodyKey)),chunkBFI4TNSD_cjs.k(this.progressEl,chunkBFI4TNSD_cjs.B(this.t,"onboarding.progress",{current:this.stepIndex+1,total:Ot.length}));let e=this.stepIndex===Ot.length-1;chunkBFI4TNSD_cjs.k(this.nextBtn,this.t(e?"onboarding.done":"onboarding.next"));}advance(){if(this.stepIndex>=Ot.length-1){this.finish();return}this.stepIndex+=1,this.renderStep(),this.position();}handleKeydown(t){if(this.finished)return;if(t.key==="Escape"){t.stopPropagation(),this.finish();return}if(t.key!=="Tab")return;let o=this.element.getRootNode().activeElement;if(!o||!this.element.contains(o))return;let i=[this.closeBtn,this.skipBtn,this.nextBtn],s=i[0],r=i[i.length-1];!s||!r||(t.shiftKey&&o===s?(t.preventDefault(),r.focus()):!t.shiftKey&&o===r&&(t.preventDefault(),s.focus()));}position(){let t=this.anchor.getBoundingClientRect(),e=this.element.getBoundingClientRect(),o=14,i=t.top-e.height-o;i<8&&(i=t.bottom+o);let s;this.alignRight?s=t.right-e.width:s=t.left,s=Math.max(8,Math.min(s,window.innerWidth-e.width-8)),this.element.style.top=`${i}px`,this.element.style.left=`${s}px`;}finish(){this.finished||(this.finished=true,fi(),document.removeEventListener("keydown",this.onKeydown,true),this.element.remove(),this.anchor.focus());}destroy(){this.finished||(this.finished=true,document.removeEventListener("keydown",this.onKeydown,true),this.element.remove());}};var Dt=class{constructor(t,e){this.store=t;this.projectName=e;}store;projectName;async sendFeedback(t){let e=await this.store.createFeedback({projectName:t.projectName,type:t.type,message:t.message,status:"open",url:t.url,urlPattern:t.urlPattern??null,viewport:t.viewport,userAgent:t.userAgent,authorName:t.authorName,authorEmail:t.authorEmail,clientId:t.clientId,annotations:t.annotations.map(chunkBFI4TNSD_cjs.s),screenshotDataUrl:t.screenshotDataUrl??null,screenshotRegion:t.screenshotRegion??null,diagnostics:t.diagnostics??null});return dt(e)}async getFeedbacks(t,e){let{feedbacks:o,total:i}=await this.store.getFeedbacks({projectName:t,page:e?.page,limit:e?.limit,type:e?.type,status:e?.status,statuses:e?.statuses,search:e?.search,url:e?.url,urlPattern:e?.urlPattern});return {feedbacks:o.map(dt),total:i}}async resolveFeedback(t,e){let o=await this.store.updateFeedback(t,chunkBFI4TNSD_cjs.r(e?"resolved":"open"));return dt(o)}async updateFeedbackMessage(t,e,o){let i=await this.store.updateFeedback(t,chunkBFI4TNSD_cjs.r(e,new Date,o));return dt(i)}async updateFeedbackAnnotations(t,e,o){let i=await this.store.updateFeedback(t,chunkBFI4TNSD_cjs.r(e,new Date,void 0,o.map(chunkBFI4TNSD_cjs.s)));return dt(i)}async deleteFeedback(t){await this.store.deleteFeedback(t);}async deleteAllFeedbacks(t){await this.store.deleteAllFeedbacks(t);}};function dt(n){return {id:n.id,projectName:n.projectName,type:n.type,message:n.message,status:n.status,url:n.url,urlPattern:n.urlPattern??null,viewport:n.viewport,userAgent:n.userAgent,authorName:n.authorName,authorEmail:n.authorEmail,resolvedAt:n.resolvedAt?.toISOString()??null,createdAt:n.createdAt.toISOString(),updatedAt:n.updatedAt.toISOString(),annotations:n.annotations.map(mi),screenshotUrl:n.screenshotUrl??null,screenshotRegion:n.screenshotRegion??null,diagnostics:n.diagnostics??null}}function mi(n){return {id:n.id,feedbackId:n.feedbackId,cssSelector:n.cssSelector,xpath:n.xpath,textSnippet:n.textSnippet,elementTag:n.elementTag,elementId:n.elementId,textPrefix:n.textPrefix,textSuffix:n.textSuffix,fingerprint:n.fingerprint,neighborText:n.neighborText,anchorKey:n.anchorKey??null,xPct:n.xPct,yPct:n.yPct,wPct:n.wPct,hPct:n.hPct,scrollX:n.scrollX,scrollY:n.scrollY,viewportW:n.viewportW,viewportH:n.viewportH,devicePixelRatio:n.devicePixelRatio,createdAt:n.createdAt.toISOString(),target:n.target??null,inspect:n.inspect??null}}var gi="linear(0, 0.006, 0.025, 0.06, 0.11, 0.17, 0.25, 0.34, 0.45, 0.56, 0.67, 0.78, 0.88, 0.95, 1.01, 1.04, 1.05, 1.04, 1.02, 1, 0.99, 1)",ge="cubic-bezier(0.16, 1, 0.3, 1)",qn="cubic-bezier(0.34, 1.56, 0.64, 1)",bi="cubic-bezier(0.25, 1, 0.5, 1)",Un=`
  /* ---- Keyframes ---- */
  ...
  .sp-anim-slide-up {
    animation: sp-slide-up 0.3s ${ge} both;
  }
  ...
  .sp-card {
    animation: sp-card-in 0.35s ${ge} both;
...
`;function be(n){return `
    ...
    *, *::before, *::after {
    ...
    ${Un}
    ${chunkBFI4TNSD_cjs.Da}
    ${chunkBFI4TNSD_cjs.Ca}
    ${chunkBFI4TNSD_cjs.ua}
    ${chunkBFI4TNSD_cjs.sa}
    ${chunkBFI4TNSD_cjs.Ka}
    ${chunkBFI4TNSD_cjs.wa}
    ${chunkBFI4TNSD_cjs.Ga}
    ${chunkBFI4TNSD_cjs.ba}
    ${Wn}
  `}var yi=120,vi=80,$t=class{constructor(t,e="en"){this.colors=t;this.locale=e;this.root=chunkBFI4TNSD_cjs.j("div",{style:`
        position: fixed;
        z-index: ${2147483647};
        max-width: 280px;
        padding: 12px 14px;
        ...
        visibility: hidden;
        -webkit-font-smoothing: antialiased;
      `}),this.root.setAttribute("role","tooltip"),this.root.id=this.tooltipId,this.arrow=chunkBFI4TNSD_cjs.j("div",{style:`
        position: absolute;
        width: 12px;
        height: 12px;
        background: ${this.colors.layerBgHeavy};
        ...
        pointer-events: none;
      `}),this.root.appendChild(this.arrow),this.root.addEventListener("mouseenter",()=>this.cancelHide()),this.root.addEventListener("mouseleave",()=>this.scheduleHide()),document.body.appendChild(this.root);}colors;locale;root;arrow;showTimer=null;hideTimer=null;currentFeedbackId=null;tooltipId="sp-tooltip";show(t,e){this.currentFeedbackId!==t.id&&(this.cancelHide(),this.cancelShow(),this.showTimer=setTimeout(()=>{this.currentFeedbackId=t.id,this.render(t),this.position(e);let o=typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;this.root.style.transition=o?"none":"",this.root.style.visibility="visible",this.root.style.opacity="1",this.root.style.transform="translateY(0) scale(1)";},yi));}scheduleHide(){this.cancelHide(),this.hideTimer=setTimeout(()=>this.hide(),vi);}hide(){this.cancelShow(),this.currentFeedbackId=null,this.root.style.opacity="0",this.root.style.transform="translateY(6px) scale(0.97)",setTimeout(()=>{this.currentFeedbackId||(this.root.style.visibility="hidden");},200);}cancelShow(){this.showTimer&&(clearTimeout(this.showTimer),this.showTimer=null);}cancelHide(){this.hideTimer&&(clearTimeout(this.hideTimer),this.hideTimer=null);}render(t){let e=Array.from(this.root.children);for(let h of e)h!==this.arrow&&h.remove();let o=chunkBFI4TNSD_cjs.ja(t.type,this.colors),i=chunkBFI4TNSD_cjs.ma(t.type,this.colors),s=chunkBFI4TNSD_cjs.A(this.locale),r=chunkBFI4TNSD_cjs.C(t.type,s),a=chunkBFI4TNSD_cjs.j("div",{style:"display:flex;align-items:center;gap:8px;margin-bottom:8px;"}),c=chunkBFI4TNSD_cjs.j("span",{style:`
        padding:3px 10px;border-radius:9999px;
        font-size:11px;font-weight:600;
        color:${o};background:${i};
        letter-spacing:0.02em;
      `});chunkBFI4TNSD_cjs.k(c,r);let l=chunkBFI4TNSD_cjs.j("span",{style:`font-size:11px;color:${this.colors.textSecondary};margin-left:auto;`});chunkBFI4TNSD_cjs.k(l,chunkBFI4TNSD_cjs.m(t.createdAt,this.locale)),a.appendChild(c),a.appendChild(l);let d=chunkBFI4TNSD_cjs.j("div",{style:`font-size:13px;line-height:1.55;color:${this.colors.text};display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;`});chunkBFI4TNSD_cjs.k(d,t.message),this.root.insertBefore(a,this.arrow),this.root.insertBefore(d,this.arrow);}position(t){let e=this.root.getBoundingClientRect(),o=10,i=t.top-e.height-o,s=t.left+t.width/2-e.width/2,r=true;i<8&&(i=t.bottom+o,r=false),s=Math.max(8,Math.min(s,window.innerWidth-e.width-8)),this.root.style.top=`${i}px`,this.root.style.left=`${s}px`;let a=Math.max(16,Math.min(t.left+t.width/2-s-6,e.width-22));r?this.arrow.style.cssText=`
        position:absolute;
      ...
      `:this.arrow.style.cssText=`
        ...
        top:-6px;
        left:${a}px;
      `;}contains(t){return this.root.contains(t)}destroy(){this.cancelShow(),this.cancelHide(),this.root.remove();}};var zt=null;function wi(n){return n===void 0||n===false?{console:false,network:false,maxConsoleEntries:50,maxNetworkEntries:20}:n===true?{console:true,network:true,maxConsoleEntries:50,maxNetworkEntries:20}:{console:n.console!==false,network:n.network!==false,maxConsoleEntries:typeof n.maxConsoleEntries=="number"?n.maxConsoleEntries:50,maxNetworkEntries:typeof n.maxNetworkEntries=="number"?n.maxNetworkEntries:20}}function Vn(n){let t=()=>{};return {destroy:t,open:t,close:t,refresh:t,focusFeedback:()=>false,on:()=>t,off:t,updateConfig:e=>{ye({...n,...e});}}}function Ei(){let n=()=>{};return {destroy:n,open:n,close:n,refresh:n,focusFeedback:()=>false,on:()=>n,off:n,getUiState:()=>({open:false,settingsExpanded:false}),expandSettings:n}}function Yn(){try{return process.env.NODE_ENV}catch{return}}function Si(n){return n===void 0||n===false?{enabled:false,param:"instafix"}:n===true?{enabled:true,param:"instafix"}:{enabled:true,param:n.param??"instafix"}}function ye(n){if(typeof window>"u"||typeof document>"u")return n.onSkip?.("ssr"),Vn(n);if(zt)return n.debug,zt.facade;let t=new Map,e={...n,...chunkBFI4TNSD_cjs.pa()};function o(a){let c=s.getUiState();s.destroy(),e={...e,...a},s=Gn(e,o)??Ei();for(let[l,d]of t)for(let h of d)s.on(l,h);c.open&&s.open(),c.settingsExpanded&&s.expandSettings();}let i=Gn(e,o);if(!i)return Vn(e);let s=i,r={destroy:()=>{s.destroy(),zt=null;},open:()=>s.open(),close:()=>s.close(),refresh:()=>s.refresh(),focusFeedback:a=>s.focusFeedback(a),on:(a,c)=>{let l=t.get(a);return l||(l=new Set,t.set(a,l)),l.add(c),s.on(a,c),()=>{l?.delete(c),s.off(a,c);}},off:(a,c)=>{t.get(a)?.delete(c),s.off(a,c);},updateConfig:o};return zt={facade:r},r}function Gn(n,t){let e=n.debug?(...u)=>console.debug("[instafix]",...u):()=>{};if(!n.forceShow&&Yn()==="production")return n.onSkip?.("production"),null;let o=typeof n.minViewportWidth=="number"&&Number.isFinite(n.minViewportWidth)?n.minViewportWidth:768;if(!n.forceShow&&window.innerWidth<o){let u="mobile";return n.onSkip?.(u),null}if(!n.store&&(!n.endpoint||typeof n.endpoint!="string"))return console.error("[instafix] Missing 'endpoint' or 'store' in config. Provide an endpoint like '/api/instafix' or a InstaFixStore instance."),null;if(!n.projectName||typeof n.projectName!="string")return console.error("[instafix] Missing or invalid 'projectName' in config. Expected a non-empty string."),null;let i=n.locale??"ko",s=i==="en"||i==="ko"?Promise.resolve():chunkBFI4TNSD_cjs.z(i).catch(()=>{}),r=chunkBFI4TNSD_cjs.A(i),a=n.scopeAnnotationsByUrl??true,c=()=>{try{let u=n.getPageScope?.();if(u)return u}catch(u){e("getPageScope() threw, falling back to pathname:",u);}return {url:window.location.pathname,urlPattern:null}};e("Initializing widget",{projectName:n.projectName,theme:n.theme??"light",locale:i,scopeAnnotationsByUrl:a});let l=wi(n.captureDiagnostics),d=l.console?new Ft(l.maxConsoleEntries):null,h=l.network?new Bt(l.maxNetworkEntries):null,p=chunkBFI4TNSD_cjs.ha(n.accentColor,n.theme);chunkBFI4TNSD_cjs.ra({accentColor:p.accent,theme:n.theme??"light",locale:i});let m=false;if(n.autoSelectionColor!==false){let u=ce();u&&(chunkBFI4TNSD_cjs.ia(p,u.hex,n.theme),m=true,chunkBFI4TNSD_cjs.ra({accentColor:p.accent}));}let f=new lt,y=new lt,E=(()=>{if(n.store)return new Dt(n.store,n.projectName);let u=n.endpoint;if(typeof u!="string"||u.length===0)throw new Error("[instafix] internal invariant: endpoint must be a non-empty string in HTTP mode");return new Mt(u,n.projectName,{apiKey:n.apiKey,headers:n.headers})})();n.onOpen&&f.on("open",n.onOpen),n.onClose&&f.on("close",n.onClose),n.onFeedbackSent&&f.on("feedback:sent",n.onFeedbackSent),n.onError&&f.on("feedback:error",n.onError),n.onAnnotationStart&&f.on("annotation:start",n.onAnnotationStart),n.onAnnotationEnd&&f.on("annotation:end",n.onAnnotationEnd);let k={"feedback:sent":()=>f.on("feedback:sent",u=>y.emit("feedback:sent",u)),"feedback:deleted":()=>f.on("feedback:deleted",u=>y.emit("feedback:deleted",u)),"feedback:error":()=>f.on("feedback:error",u=>y.emit("feedback:error",u)),"panel:open":()=>f.on("open",()=>y.emit("panel:open")),"panel:close":()=>f.on("close",()=>y.emit("panel:close")),"annotation:start":()=>f.on("annotation:start",()=>y.emit("annotation:start")),"annotation:end":()=>f.on("annotation:end",()=>y.emit("annotation:end"))};for(let u of Object.values(k))u();f.on("open",()=>e("Panel opened")),f.on("close",()=>e("Panel closed")),f.on("feedback:sent",u=>e("Feedback sent",u.id)),f.on("feedback:error",u=>e("Feedback failed",u.message)),f.on("annotation:start",()=>e("Annotation started")),f.on("annotation:end",()=>e("Annotation ended"));let b=document.createElement("instafix-widget");b.style.cssText=`position:fixed;z-index:${2147483647};`;let B=Yn()==="test"?"open":"closed",A=b.attachShadow({mode:B});if("adoptedStyleSheets"in ShadowRoot.prototype){let u=new CSSStyleSheet;u.replaceSync(be(p)),A.adoptedStyleSheets=[u];}else {let u=document.createElement("style");u.textContent=be(p),A.appendChild(u);}if(document.body.appendChild(b),n.avoidOverlays!==false&&!n.position){let u=le("bottom-right",b);u!=="bottom-right"&&(n={...n,position:u});}n.avoidOverlays!==false&&!n.position&&setTimeout(()=>{if(O)return;let u=le("bottom-right",b);u!=="bottom-right"&&t({position:u});},1e3);let w=new MutationObserver(()=>{b.nextSibling&&document.body.appendChild(b);});w.observe(document.body,{childList:true}),n.autoSelectionColor!==false&&!m&&requestAnimationFrame(()=>{if(O)return;let u=ce(b);u&&(chunkBFI4TNSD_cjs.ia(p,u.hex,n.theme),chunkBFI4TNSD_cjs.ra({accentColor:p.accent}),b.style.setProperty("--sp-accent",p.accent),b.style.setProperty("--sp-accent-light",p.accentLight),b.style.setProperty("--sp-accent-dark",p.accentDark),b.style.setProperty("--sp-accent-glow",p.accentGlow),b.style.setProperty("--sp-accent-gradient",p.accentGradient),b.style.setProperty("--sp-accent-fill",p.accentFill),b.style.setProperty("--sp-accent-fill-gradient",p.accentFillGradient),b.style.setProperty("--sp-accent-fg",p.accentForeground),b.style.setProperty("--sp-accent-ink",p.accentInk),b.style.setProperty("--sp-selection",p.selection),b.style.setProperty("--sp-selection-light",p.selectionLight),b.style.setProperty("--sp-selection-glow",p.selectionGlow),b.style.setProperty("--sp-selection-gradient",p.accentGradient),b.style.setProperty("--sp-layer-bg",p.layerBg),b.style.setProperty("--sp-layer-bg-heavy",p.layerBgHeavy),b.style.setProperty("--sp-layer-border",p.layerBorder));});let v=chunkBFI4TNSD_cjs.c(b),C=document.createElement("div");C.setAttribute("role","status"),C.setAttribute("aria-live","polite"),C.setAttribute("aria-atomic","true"),C.style.cssText="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;",document.body.appendChild(C);let H=new $t(p,i),R=new Ht(p,H,f,r,C),pt=new Pt(A,n,f,r);f.on("markers:changed",u=>pt.updateBadge(u));let ve=null;typeof window<"u"&&!jn()&&setTimeout(()=>{if(O)return;let u=(n.position??"bottom-right")==="bottom-right";ve=new _t(A,r,pt.buttonElement,u);},600);let P=null,Kt=null,O=false,ht=0;async function Xt(){return O?null:P||(Kt||(Kt=import('./panel-I7ZUBFU2.cjs').then(u=>O?null:(P=new u.Panel(A,p,f,E,n.projectName,R,r,i,{getScope:c,scopeAnnotationsByUrl:a},{config:n,onUpdateConfig:t}),P))),Kt)}if(typeof window<"u"){let u=()=>{O||Xt();},T=window.requestIdleCallback;typeof T=="function"?T(u):setTimeout(u,200);}let Y=false,Jn=f.on("panel:toggle",u=>{P||(u?(Y=true,Xt().then(T=>{T&&Y&&T.open(),Y=false;}).catch(T=>e("Failed to lazy-load panel:",T))):Y=false);}),Zn=f.on("position:toggle",()=>{let u=(n.position??"bottom-right")==="bottom-right"?"bottom-left":"bottom-right";chunkBFI4TNSD_cjs.qa({position:u}),t({position:u});}),xe=new Rt(p,f,r,n.enableScreenshot??false,()=>v.getLastPageFocus(),n.agentInstructions);i!=="en"&&i!=="ko"&&s.then(()=>{O||(pt.refreshLabels(),xe.refreshLabels());});let jt=false,Qn=f.on("annotation:complete",async u=>{if(jt){f.emit("submission:cancelled");return}jt=true;try{let{annotations:T,type:M,message:N,screenshotDataUrl:G,screenshotRegion:J}=u,z=n.identity??he();if(!z){if(z=await ki(A,r),!z){f.emit("submission:cancelled");return}_n(z);}let _=(()=>{try{return crypto.randomUUID()}catch{return `${Date.now()}-${Math.random().toString(36).slice(2)}`}})(),et=c(),Se=null;(d||h)&&(Se={console:d?.getEntries()??[],network:h?.getEntries()??[]});let no={projectName:n.projectName,type:M,message:N,url:et.url,urlPattern:et.urlPattern,viewport:`${window.innerWidth}x${window.innerHeight}`,userAgent:navigator.userAgent,authorName:z.name,authorEmail:z.email,annotations:T,clientId:_,screenshotDataUrl:G??null,screenshotRegion:J??null,diagnostics:Se};try{let q=await E.sendFeedback(no);f.emit("feedback:sent",q),(!a||q.url===et.url)&&R.addFeedback(q,R.count+1),C.textContent=r("feedback.sent.confirmation"),P&&await P.refresh();}catch(q){f.emit("feedback:error",q instanceof Error?q:new Error(String(q))),C.textContent=r("feedback.error.message");}}finally{jt=false;}}),Wt=c(),to=a?{limit:20,url:Wt.url}:{limit:20},qt=Si(n.deepLink),eo=++ht;Promise.all([E.getFeedbacks(n.projectName,to),s]).then(([{feedbacks:u}])=>{if(O||ht!==eo)return;let T=a?u.filter(M=>M.url===Wt.url):u;if(R.render(T),qt.enabled)try{let M=new URLSearchParams(window.location.search).get(qt.param);if(M){let N=R.focusFeedback(M);e(`deepLink ?${qt.param}=${M} ${N?"focused":"did not match a visible feedback"}`);}}catch(M){e("deepLink parsing failed:",M);}}).catch(u=>{e("Failed to load initial markers:",u);}),n.endpoint&&Sn(n.endpoint,n.identity??he(),{apiKey:n.apiKey,headers:n.headers}).then(()=>e("Retry queue flushed")).catch(()=>{});let we=()=>{let u=++ht;if(P?.isCurrentlyOpen)return P.refresh();let T=c(),M=a?{limit:20,url:T.url}:{limit:20};return E.getFeedbacks(n.projectName,M).then(({feedbacks:N})=>{if(O||u!==ht||P?.isCurrentlyOpen)return;let G=a?N.filter(J=>J.url===T.url):N;R.render(G);})},Ee=null;if(n.watchNavigation!==false&&typeof window<"u"&&typeof history<"u"){let u=_=>`${_.url}
${_.urlPattern??""}`,T=u(Wt),M=()=>{if(O)return;let _=u(c());if(_===T)return;let et=T;T=_,e("SPA navigation detected \u2014 refreshing feedbacks for new scope"),we().catch(()=>{T===_&&(T=et);});},N=history.pushState,G=history.replaceState,J=function(..._){N.apply(this,_),M();},z=function(..._){G.apply(this,_),M();};history.pushState=J,history.replaceState=z,window.addEventListener("popstate",M),window.addEventListener("hashchange",M),Ee=()=>{window.removeEventListener("popstate",M),window.removeEventListener("hashchange",M),history.pushState===J&&(history.pushState=N),history.replaceState===z&&(history.replaceState=G);};}return {destroy:()=>{O||(e("Destroying widget"),O=true,Y=false,w.disconnect(),Ee?.(),v.destroy(),Qn(),Jn(),Zn(),pt.destroy(),ve?.destroy(),P?.destroy(),xe.destroy(),R.destroy(),H.destroy(),d?.dispose(),h?.dispose(),f.removeAll(),y.removeAll(),C.remove(),b.remove());},open:()=>{f.emit("panel:toggle",true);},close:()=>{P?P.close():Y=false;},focusFeedback:u=>R.focusFeedback(u),refresh:()=>{we().catch(()=>{});},on:(u,T)=>y.on(u,T),off:(u,T)=>{y.off(u,T);},getUiState:()=>({open:P?.isCurrentlyOpen??false,settingsExpanded:P?.isSettingsExpanded??false}),expandSettings:()=>{Xt().then(u=>u?.expandSettings());}}}function ki(n,t){return new Promise(e=>{let o=n.activeElement??document.activeElement,i=n.host;i.parentNode&&i.parentNode.appendChild(i);let s=document.createElement("div");s.style.cssText=`
      position:fixed;inset:0;
