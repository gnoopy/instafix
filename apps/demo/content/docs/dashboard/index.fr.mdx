...
`InstaFixInbox` accepte toutes les [options de `useInstaFixInbox`](/fr/docs/dashboard/headless) plus ces props de présentation :
...
| `locale` | `string` | `"ko"` | N'importe quelle étiquette BCP-47 — voir [Langues](#langues) |
