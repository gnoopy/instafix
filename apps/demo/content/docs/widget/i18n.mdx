...
`@instafix/dashboard` ships the same seven locales with the same resolution rules, and exports its own `registerLocale` with the same partial-dictionary behavior — see [the dashboard docs](/docs/dashboard#languages).
