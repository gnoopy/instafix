...
> Masquer un élément l'exclut aussi du sélecteur de ciblage automatique de la barre d'outils — le widget traite `data-instafix-ignore` comme un « ne pas y toucher ».
