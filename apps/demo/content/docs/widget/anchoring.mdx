...
When a client draws a rectangle, InstaFix doesn't store screen coordinates — those break on the first layout change. It anchors the annotation to the **DOM element** under it, with layered fallbacks:
