...
La route au format SQLite n'a besoin que de `@instafix/adapter-sqlite` installé — aucun client à brancher, aucun schéma à pousser ; voir l'[adapter SQLite](/fr/docs/adapters/sqlite).
