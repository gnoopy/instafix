...
Le CLI InstaFix automatise l'installation du projet et les vérifications de santé. Il est livré comme un binaire autonome unique, avec **zéro dépendance à l'exécution**, et exige **Node 22 ou plus récent**.
