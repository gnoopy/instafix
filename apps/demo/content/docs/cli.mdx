...
The SQLite-flavored route only needs `@instafix/adapter-sqlite` installed — no client to wire up, no schema to push; see the [SQLite adapter](/docs/adapters/sqlite).
