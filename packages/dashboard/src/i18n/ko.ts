...
export const ko: Translations = {
  // Inbox chrome
  "inbox.regionLabel": "피드백 수신함",
  "inbox.listLabel": "피드백 목록",
  "inbox.statusFilter": "상태별 필터",
  "inbox.searchPlaceholder": "메시지 검색…",
  "inbox.searchAria": "피드백 검색",
  "inbox.clearSearch": "검색어 지우기",
  "inbox.resultsCount": "피드백 {count}개",
  ...
  // Empty / error states
  "inbox.emptyTitle": "아직 피드백이 없습니다",
  "inbox.emptySub": "위젯에서 전송된 피드백이 여기에 표시됩니다.",
  "inbox.emptyFilteredTitle": "표시할 항목이 없습니다",
  "inbox.emptyFilteredSub": "이 필터와 일치하는 피드백이 없습니다.",
  "inbox.viewAll": "전체 보기",
  "inbox.inboxZeroTitle": "모두 처리됨",
  "inbox.inboxZeroSub": "열려 있던 모든 피드백이 처리되었습니다.",
  "inbox.loadError": "피드백을 불러오지 못했습니다",
  "inbox.retry": "다시 시도",
  ...
  "drawer.noScreenshot": "이 피드백에는 스크린샷이 없습니다",
  "drawer.delete": "피드백 삭제",
