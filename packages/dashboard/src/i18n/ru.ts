...
export const ru: Translations = {
  // Inbox
  "inbox.regionLabel": "Входящие fix notes",
  "inbox.listLabel": "Список fix notes",
  "inbox.statusFilter": "Фильтр по статусу",
  "inbox.searchPlaceholder": "Поиск по сообщениям…",
  "inbox.searchAria": "Поиск по fix notes",
  "inbox.clearSearch": "Очистить поиск",
  "inbox.resultsCount": "Fix notes: {count}",
  ...
  "inbox.emptyTitle": "Пока нет fix notes",
  "inbox.emptySub": "Fix notes, отправленные из виджета, появляются здесь.",
  "inbox.emptyFilteredTitle": "Ничего нет",
  "inbox.emptyFilteredSub": "Ни одна fix note не соответствует этому фильтру.",
  "inbox.viewAll": "Показать все",
  "inbox.inboxZeroTitle": "Всё разобрано",
  "inbox.inboxZeroSub": "Все открытые fix notes обработаны.",
  "inbox.loadError": "Не удалось загрузить fix notes",
  ...
  "drawer.noScreenshot": "Для этой fix note нет скриншота",
  "drawer.delete": "Удалить fix note",
