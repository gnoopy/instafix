...
export type RouteBackend = "sqlite" | "fs";
 ...
 * (defaults to `"sqlite"` — zero external services, the recommended default
 * for a team). Skips if the file already exists — it is never overwritten,
 * regardless of `backend`.
 */
export function generateRoute(
  basePath: string = process.cwd(),
  backend: RouteBackend = "sqlite",
