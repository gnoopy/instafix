import type { FeedbackStatus, FeedbackType } from "@instafix/core";
import { tWithParams as coreTWithParams, createI18n, interpolate } from "@instafix/core";
...
//
// `ko` is also bundled synchronously: it's the widget's default locale (see
// `launcher.ts`), and hosts that don't configure a locale must render in
// Korean immediately, with no flash of English while a chunk loads.
//
