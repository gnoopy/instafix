...
describe("KeyboardShortcuts", () => {
  ...
  // -------------------------------------------------------------------------
  // Help overlay Tab focus trap
  // -------------------------------------------------------------------------

  describe("help overlay Tab focus trap", () => {
    beforeEach(() => {
    ...
    it("keeps Tab focus on the close button (the only focusable element)", () => {
      const closeBtn = shortcuts.helpOverlay.querySelector<HTMLButtonElement>(".sp-shortcuts-close")!;
    ...
    it("keeps Shift+Tab focus on the close button too", () => {
      const closeBtn = shortcuts.helpOverlay.querySelector<HTMLButtonElement>(".sp-shortcuts-close")!;
      Object.defineProperty(shadow, "activeElement", { value: closeBtn, configurable: true });
    ...
    it("does not intercept Tab once the overlay is closed", () => {
      shortcuts.toggleHelp(); // close it
      const event = makeKeydown("Tab");
      const prevent = vi.spyOn(event, "preventDefault");
      shadow.dispatchEvent(event);
      expect(prevent).not.toHaveBeenCalled();
